...
func (_m *Interface) GetEgressFirewalls() (*egressfirewallv1.EgressFirewallList, error) {
	ret := _m.Called()
...
func (_m *Interface) GetEgressIP(name string) (*egressipv1.EgressIP, error) {
	ret := _m.Called(name)
...
func (_m *Interface) GetEgressIPs() (*egressipv1.EgressIPList, error) {
	ret := _m.Called()
...
func (_m *Interface) PatchEgressIP(name string, patchData []byte) error {
...
func (_m *Interface) UpdateEgressFirewall(egressfirewall *egressfirewallv1.EgressFirewall) error {
...
func (_m *Interface) UpdateEgressIP(eIP *egressipv1.EgressIP) error {
	ret := _m.Called(eIP)
